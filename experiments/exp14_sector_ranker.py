...
def main():
    ...
    print("  sector stability:")
    print(f"    spectral radius = {metrics.get('sector_spectral_radius', float('nan')):.4f}")
    print(f"    max row sum     = {metrics.get('sector_max_row_sum', float('nan')):.4f}")
