...
loader of \cref{ch13:sec:phase0}. It reflects the column memory already
encoded in the repository's observation layer (\code{synthetic/observe.py},
\code{synthetic/macro.py}, \code{synthetic/loaders.py}), which mirrors
the production PitchBook/FactSet extracts; the real adapter must treat
any divergence between this dictionary and a delivered extract as an
audit failure, not something to patch silently.
