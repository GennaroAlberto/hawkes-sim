...
The investment case study reports that under correct specification the augmented interval-censored estimator recovers branching ratios within roughly $0.03$ and covariate coefficients within roughly $0.08$. Under deliberate misspecification--heavy-tailed triggering, nonlinear self-inhibition, and cross-sector coupling--the estimator still recovers the sign and significance of the covariate effect and improves held-out predictive likelihood, although magnitude can be inflated by kernel mismatch.
